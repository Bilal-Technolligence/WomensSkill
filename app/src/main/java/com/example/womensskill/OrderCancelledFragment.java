...
public class OrderCancelledFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_ordercancelled, container, false);
        try {
            ...
            databaseReference.child("Order").orderByChild("status").equalTo("Cancelled").addValueEventListener(new ValueEventListener() {
                @Override
